...
export const imageAssets = {
    ...
    '/banner6.png': require('./../assets/images/banner5.png'),
    '/banner7.png': require('./../assets/images/banner1.png'),
    '/banner8.png': require('./../assets/images/banner2.png'),
    '/banner9.png': require('./../assets/images/banner3.png'),
    '/banner10.png': require('./../assets/images/banner4.png'),
    '/banner11.png': require('./../assets/images/banner5.png'),
    '/banner12.png': require('./../assets/images/banner5.png'),
